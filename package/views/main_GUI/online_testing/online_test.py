...
class OnlineTest():
    def onClicked_pushButton_online_ssvep_task(self):
        ...
        self.bp_filter_full = Filter(low_cut=0.05, hi_cut=40, order=2, sf=self.sr.sample_rate, n_chan=len(self.sr.ch_list)-1)
        self.EEGNET_buffer = SSVEPBuffer(self, window_stride=window_stride, window_size=window_size, buffer_size=10,
